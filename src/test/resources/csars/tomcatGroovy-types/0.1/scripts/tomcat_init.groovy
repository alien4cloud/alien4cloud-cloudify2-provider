...
def catalinaHome = config.catalinaHome ?: "${context.serviceDirectory}/scripts/${config.name}"
def catalinaBase = config.catalinaBase ?: catalinaHome
def catalinaOpts = config.catalinaOpts ?: ""
def javaOpts = config.javaOpts ?: ""
// def contextPath = contextPath ?: (context.applicationName != "default")? context.applicationName : "ROOT"
